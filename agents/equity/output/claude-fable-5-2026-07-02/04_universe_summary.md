...
| Bar freshness | last bar = 2026-07-02 | 1 — SATS (last bar 2026-07-01; did not trade today; unresolved corporate-action state) |
| Price | > $5 | 0 |
| Liquidity | ADV$20d > $20M | 0 |
| Session coverage | >= 80% of last 60 sessions | 0 |
| **Eligible** | | **513** |

Market-cap (> $2B) and listing filters are structurally satisfied by S&P 500 / Nasdaq-100 membership (INFERRED, index inclusion criteria); no independent market-cap feed was fetched. Core ETFs (SPY/QQQ/SOXX) analyzed separately — never universe members. Intraday note: the current-day bar is a live partial bar (fetched ~15:21 ET); 20d volume ratios understate the session symmetrically across all names.
...
| Earnings dates | 70 shortlist names, cadence-estimated ESTIMATED (±5d) | -0.10 penalty inside 19d buffered window (7 names hit: IBKR, JBHT, UAL, UNH, CFG, ELV, AXP) |
