...
| Re-inclusion note | | SATS re-eligible: traded 2026-07-02 after missing 2026-07-01; corporate-action watch retained as a note only |
...
Market-cap (> $2B) and listing filters are structurally satisfied by S&P 500 / Nasdaq-100 membership (INFERRED, index inclusion criteria); no independent market-cap feed was fetched. Core ETFs (SPY/QQQ/SOXX) analyzed separately — never universe members. Bars are final 2026-07-02 closes (holiday run — no partial-bar caveats).
...
| Technical pack daily (TD9/RSI/MACD/MA/mom/VR/RS) | 514/514 TD9, 514/514 RSI, 514/514 MACD (>=70% bar met) | contributes to Tech_Z |
| Technical pack weekly/monthly | 514/514 weekly RSI, 513/514 monthly RSI | diagnostics + exhaustion flags |
...
| Earnings dates | 76 shortlist names, cadence-estimated ESTIMATED (±5d) | -0.10 penalty inside 19d buffered window (7 names hit: IBKR, JBHT, UAL, UNH, CFG, ELV, AXP) |
